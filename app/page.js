    ...
    <div className="min-h-screen bg-[#FAFAFA]">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              >
                <div className="p-8">
                  ...
                  <h2 className="text-2xl font-bold text-[#1A1A1A] mb-4">M-Class</h2>
                  <p className="text-gray-600 mb-6">
                    Live interactive music classes with professional instructors. Real-time feedback and personalized attention.
                  </p>
                  <ul className="text-gray-600 mb-8 space-y-2">
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-[#3F51B5] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="p-8">
                  ...
                  <h2 className="text-2xl font-bold text-[#1A1A1A] mb-4">E-Class</h2>
                  <p className="text-gray-600 mb-6">
                    Access our curated collection of video lessons. Learn at your own pace with structured content.
                  </p>
                  <ul className="text-gray-600 mb-8 space-y-2">
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-[#009688] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                      </svg>
                      Video Tutorials
                    </li>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-[#1A1A1A] mb-4">Why Choose eMusic Learning?</h2>
          <p className="text-gray-600">Experience the best of both worlds with our comprehensive learning options</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-[#1A1A1A] mb-2">Flexible Learning</h3>
            <p className="text-gray-600">Choose between live classes or self-paced video lessons</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-[#1A1A1A] mb-2">Quality Content</h3>
            <p className="text-gray-600">Structured curriculum and high-quality learning materials</p>
          </div>
        </div>
      </div>
    </div>
